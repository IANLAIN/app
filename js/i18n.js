const translations = {
  es: {
    "nav.home": "Inicio", "nav.why": "¿Por qué incluIA?", "nav.mentoring": "Mentoría", "nav.donate": "Cómo apoyarnos",
    ...
    "landing.stat.2.val": "3.2x", "landing.stat.2.label": "Velocidad de adaptación",
    "landing.stat.3.val": "+48", "landing.stat.3.label": "Empresas aliadas",
    "landing.how.title": "Cómo funciona", "landing.how.desc": "Un recorrido en tres pasos con foco en autonomía, claridad y acompañamiento.",
    ...
    "dash.comp.hero.eyebrow": "Panel ESG y talento", "dash.comp.hero.title": "Empresa aliada: Nube Verde", "dash.comp.hero.desc": "Resumen de candidatos, guías de adaptación y métricas de impacto.", "dash.comp.hero.hint": "Operando sobre infraestructura segura.", "dash.comp.hero.btn.interview": "Programar entrevista", "dash.comp.hero.btn.report": "Descargar reporte",
    "dash.comp.match.title": "Match de perfil sugerido", "dash.comp.match.desc": "Seleccionados por habilidades y contexto de apoyo.", "dash.comp.match.1.score": "92% match", "dash.comp.match.1.name": "Sara M.", "dash.comp.match.1.desc": "Analista QA, foco alto, requiere espacio silencioso.", "dash.comp.match.2.score": "88% match", "dash.comp.match.2.name": "Diego R.", "dash.comp.match.2.desc": "Soporte TI, buen manejo de procesos y checklists.", "dash.comp.match.3.score": "85% match", "dash.comp.match.3.name": "Lina P.", "dash.comp.match.3.desc": "Analista datos, alto detalle, prefiere tareas secuenciales.",
  ...
  en: {
    ...
    "landing.stat.2.val": "3.2x", "landing.stat.2.label": "Adaptation speed",
    "landing.stat.3.val": "+48", "landing.stat.3.label": "Partner companies",
    "landing.how.title": "How it works", "landing.how.desc": "A three-step journey focused on autonomy, clarity, and support.",
    ...
    "dash.comp.hero.eyebrow": "ESG and talent dashboard", "dash.comp.hero.title": "Partner company: Nube Verde", "dash.comp.hero.desc": "Candidate overview, adaptation guides, and impact metrics.", "dash.comp.hero.hint": "Running on secure infrastructure.", "dash.comp.hero.btn.interview": "Schedule interview", "dash.comp.hero.btn.report": "Download report",
    "dash.comp.match.title": "Suggested profile match", "dash.comp.match.desc": "Selected by skills and support context.", "dash.comp.match.1.score": "92% match", "dash.comp.match.1.name": "Sara M.", "dash.comp.match.1.desc": "QA Analyst, high focus, requires quiet space.", "dash.comp.match.2.score": "88% match", "dash.comp.match.2.name": "Diego R.", "dash.comp.match.2.desc": "IT Support, good at processes and checklists.", "dash.comp.match.3.score": "85% match", "dash.comp.match.3.name": "Lina P.", "dash.comp.match.3.desc": "Data Analyst, high detail, prefers sequential tasks.",
  ...
  fr: {
    ...
    "landing.stat.2.val": "3.2x", "landing.stat.2.label": "Vitesse d'adaptation",
    "landing.stat.3.val": "+48", "landing.stat.3.label": "Entreprises partenaires",
    "landing.how.title": "Comment ça marche", "landing.how.desc": "Un parcours en trois étapes axé sur l'autonomie, la clarté et le soutien.",
    ...
    "dash.comp.hero.eyebrow": "Tableau de bord ESG et talents", "dash.comp.hero.title": "Entreprise partenaire : Nube Verde", "dash.comp.hero.desc": "Aperçu des candidats, guides et métriques d'impact.", "dash.comp.hero.hint": "Fonctionnant sur une infrastructure sécurisée.", "dash.comp.hero.btn.interview": "Planifier l'entretien", "dash.comp.hero.btn.report": "Télécharger le rapport",
    "dash.comp.match.title": "Correspondance de profil suggérée", "dash.comp.match.desc": "Sélectionnés par compétences et contexte.", "dash.comp.match.1.score": "92% match", "dash.comp.match.1.name": "Sara M.", "dash.comp.match.1.desc": "Analyste QA, concentration élevée, nécessite du calme.", "dash.comp.match.2.score": "88% match", "dash.comp.match.2.name": "Diego R.", "dash.comp.match.2.desc": "Support IT, à l'aise avec les processus.", "dash.comp.match.3.score": "85% match", "dash.comp.match.3.name": "Lina P.", "dash.comp.match.3.desc": "Analyste données, tâches séquentielles.",
  ...
  pt: {
    ...
    "landing.stat.2.val": "3.2x", "landing.stat.2.label": "Velocidade de adaptação",
    "landing.stat.3.val": "+48", "landing.stat.3.label": "Empresas parceiras",
    "landing.how.title": "Como funciona", "landing.how.desc": "Uma jornada de três etapas focada em autonomia, clareza e apoio.",
    ...
    "dash.comp.hero.eyebrow": "Painel ESG e talentos", "dash.comp.hero.title": "Empresa parceira: Nube Verde", "dash.comp.hero.desc": "Resumo de candidatos, guias de adaptação e métricas de impacto.", "dash.comp.hero.hint": "Operando em infraestrutura segura.", "dash.comp.hero.btn.interview": "Agendar entrevista", "dash.comp.hero.btn.report": "Baixar relatório",
    "dash.comp.match.title": "Correspondência de perfil sugerida", "dash.comp.match.desc": "Selecionados por habilidades e contexto de suporte.", "dash.comp.match.1.score": "92% match", "dash.comp.match.1.name": "Sara M.", "dash.comp.match.1.desc": "Analista QA, alto foco, requer espaço silencioso.", "dash.comp.match.2.score": "88% match", "dash.comp.match.2.name": "Diego R.", "dash.comp.match.2.desc": "Suporte TI, bom com processos e checklists.", "dash.comp.match.3.score": "85% match", "dash.comp.match.3.name": "Lina P.", "dash.comp.match.3.desc": "Analista de dados, detalhes, prefere tarefas sequenciais.",
